...
public class Test4 {
	 public static void main(String[] args) {
		    ...
		    //Création Participation
			  ...
			  projet1.ajouterParticipant(emp1,"chef de projet");
			  projet2.ajouterParticipant(emp1,"chef de projet");
			  projet1.ajouterParticipant(emp2,"ingénieur E&D");
			  projet3.ajouterParticipant(emp2,"ingénieur E&D");
			  projet2.ajouterParticipant(emp3,"architecte");
